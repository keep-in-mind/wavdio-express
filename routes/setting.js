...
router.route('/setting').get((request, response) => {
...
router.route('/setting').post((request, response) => {
...
router.route('/setting/:setting_id').get((request, response) => {
...
router.route('/setting/:setting_id').put((request, response) => {
...
router.route('/setting/:setting_id').patch((request, response) => {
...
router.route('/setting/:setting_id').delete((request, response) => {
