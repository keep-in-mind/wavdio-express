...
router.route('/infopage').get((request, response) => {
...
router.route('/infopage').post((request, response) => {
...
router.route('/infopage/:infopage_id').get((request, response) => {
...
router.route('/infopage/:infopage_id').put((request, response) => {
...
router.route('/infopage/:infopage_id').patch((request, response) => {
...
router.route('/infopage/:infopage_id').delete((request, response) => {
